...
def hangman(secretWord):
    ...
    * After each round, you should also display to the user the
    ...
    print greeting
    print "I am thinking of a word that is {} letters long".format(lenw)
    print "-"*12
    ...
    while True:
        guessleft = 8 - mistakeMade
        if guessleft <= 0:
            print "Sorry, you ran out of guesses. The word was {}.".format(secretWord)
            break

        print "You have {} guesses left.".format(8 - mistakeMade)
        ...
        if guess in lettersGuessed:
            ...
            print "Oops! You've already guessed that letter: {}".format(guessword)
            print "-"*12
            continue
        else:
            lettersGuessed.append(guess)
            guessword = getGuessedWord(secretWord, lettersGuessed)
            #print "Debug: ", secretWord, lettersGuessed, guessword, mistakeMade
            if guess in secretWord:
                print "Good guess: {}".format(guessword)
                print "-"*12
            else:
                mistakeMade += 1
                print "Oops! That letter is not in my word: {}".format(guessword)
                print "-"*12
